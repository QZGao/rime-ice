...
class Translator:
	def __init__(self, convert_method: str):
		...
		self.translation_dict_file = f"tw_dicts/trans_dict_{convert_method}.txt"
		self.translation_dict = self.__load_translation_dict()
		self.translation_dict_unchecked_file = f"tw_dicts/trans_dict_{convert_method}_unchecked.txt"
